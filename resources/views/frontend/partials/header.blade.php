    ...
    <div class="max-w-7xl mx-auto px-3 sm:px-6 py-2 sm:py-4">
        <div class="grid grid-cols-[auto_1fr_auto] gap-x-3 gap-y-3 sm:grid-cols-[1fr_auto_1fr] sm:gap-y-0 items-center">
            ...
            <div class="col-start-3 row-start-1 justify-self-end sm:col-start-3 sm:justify-self-end flex items-center py-0.5">
                <img src="{{ asset('/storage/logos/Logo1.png') }}" alt="University of Dar es Salaam" class="h-8 w-auto max-h-8 object-contain object-center sm:h-14 sm:max-h-[60px] md:h-[4.5rem] md:max-h-[72px]">
            </div>
        </div>
    </div>
</header>
...
<div class="sticky top-0 z-50">
    <nav class="header-desktop-nav w-full bg-[#2C63AA] border-t border-white/15">
        <div class="max-w-7xl mx-auto px-3 sm:px-6 py-2">
            <div class="md:hidden flex items-center justify-between">
                <span class="text-white text-sm font-medium">Menu</span>
                <button
                    type="button"
                    class="inline-flex h-9 w-9 items-center justify-center rounded-lg border border-white/25 bg-white/10 text-white"
