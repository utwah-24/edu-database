    ...
    <div class="max-w-7xl mx-auto px-3 sm:px-6 py-2 sm:py-4">
        <div class="grid grid-cols-[auto_1fr_auto] gap-x-3 gap-y-3 sm:grid-cols-[1fr_auto_1fr] sm:gap-y-0 items-center">
            ...
            <a href="{{ route('frontend.home') }}" class="hidden sm:block col-start-2 row-start-1 sm:col-span-1 sm:row-start-1 sm:col-start-2 justify-self-center text-center min-w-0 max-w-[min(100%,360px)] sm:max-w-xl md:max-w-2xl lg:max-w-4xl px-2">
                <p class="font-heading text-[0.5rem] font-extrabold uppercase leading-[1.02] tracking-wide text-foreground sm:text-[0.984375rem] md:text-[1.18125rem] lg:text-[1.575rem] xl:text-[1.96875rem]">Utafiti Elimu Tanzania</p>
                <p class="font-heading mt-0.5 sm:mt-2 text-[0.5rem] font-semibold uppercase leading-[1.02] tracking-wide text-[#2C63AA] sm:text-[0.984375rem] md:text-[1.18125rem] lg:text-[1.575rem] xl:text-[1.96875rem]">University of Dar es Salaam</p>
            </a>
